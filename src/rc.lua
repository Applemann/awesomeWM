...
winkey = "Mod4"
modkey = winkey
ctrlalt = { "Control", "Mod1" }


beautiful.wallpaper = "/home/martin/Pictures/symbols/wallper.jpg"
...
mainmenu = awful.menu({ items = { 
    { "awesome", myawesomemenu, beautiful.awesome_icon },
	  ...
	  { "firefox","/usr/bin/firefox","/usr/share/pixmaps/firefox.xpm" },
    { "open terminal", terminal }
  }
})

mylauncher = awful.widget.launcher({ image = "/home/martin/Pictures/symbols/firewater.jpg", menu = mainmenu })
...
kbdcfg.switch = function ()
  ...
  awful.util.spawn_with_shell('xmodmap -e "keycode 9 = Escape NoSymbol Escape" ')
  awful.util.spawn_with_shell('xmodmap -e "keycode 66 = Escape NoSymbol Escape"')
end
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ altkey, }, "p",   awful.tag.viewprev, {description = "view previous", group = "tag"}),
    awful.key({ altkey, }, "n",  awful.tag.viewnext, {description = "view next", group = "tag"}),
    awful.key( ctrlalt, "h",   awful.tag.viewprev, {description = "view previous", group = "tag"}),
    awful.key( ctrlalt, "l",  awful.tag.viewnext, {description = "view next", group = "tag"}),

    awful.key({ modkey, }, "Escape", awful.tag.history.restore, {description = "go back", group = "tag"}),
    awful.key({ altkey, }, "l", awful.tag.history.restore, {description = "go back", group = "tag"}),
    awful.key( ctrlalt, ";", awful.tag.history.restore, {description = "go back", group = "tag"}),



    ---- Change windows (C-Tab) ----
    awful.key({ altkey, }, "Tab", function () awful.client.focus.byidx( 1) end, {description = "focus next by index", group = "client"}), 
    awful.key({ altkey, "Shift" }, "Tab", function () awful.client.focus.byidx(-1) end, {description = "focus previous by index", group = "client"}),

    awful.key({ modkey, }, "n", function () awful.client.focus.byidx( 1) end, {description = "focus next by index", group = "client"}),
    awful.key({ modkey, }, "p", function () awful.client.focus.byidx(-1) end, {description = "focus previous by index", group = "client"}),
...
awful.key({ altkey, "Shift" }, "p",
          function ()
              if client.focus then
                  i = awful.screen.focused().selected_tag.index -1
